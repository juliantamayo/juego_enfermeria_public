...
import D_C3_pregunta2_Resp_enfermera from "../../../data/C3_data/C3_preguntas/D_C3_pregunta2_Resp_enfermera";
...
class V_C3_Preg2_pregunta extends React.Component {
    ...
    this.setState(state => {
      ...
      if (nextIndex >= state.totalCount && this.state.correctCount < 1) {
       ...
       return this.props.navigation.navigate('V_C3_RespP2_enfermera',{repu_enferme:1,experiencia: (this.state.correctCount*mult)-((this.state.totalCount-this.state.correctCount)*3), correctas:this.state.correctCount,erroneas:(this.state.totalCount-this.state.correctCount),
        title: "RespuestaP2 C3 enfermero",
...
export default V_C3_Preg2_pregunta;
