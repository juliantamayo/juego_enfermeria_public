...
import { Modal, View,ScrollView, StyleSheet, Dimensions, StatusBar, Text, SafeAreaView, Image, ImageBackground, TouchableOpacity, TouchableHighlight, Alert} from "react-native";
...
import D_C3_pregunta4_pregunta from "../../../data/C3_data/C3_preguntas/D_C3_pregunta4_pregunta";
...
class V_C3_Preg4_dialogo extends React.Component {
    ...
    this.setState(state => {
      ...
      if (nextIndex >= state.totalCount) {
       // return this.props.navigation.popToTop();
        return this.props.navigation.navigate("V_C3_Preg4_pregunta", {activeQuestion: 1, 
          title: "Caso 3. Pregunta 4",
          questions: D_C3_pregunta4_pregunta,
          color: "#36b1f0"
        });
      }
...
export default V_C3_Preg4_dialogo;
