...
import { Modal, View, StyleSheet,ScrollView, StatusBar, Text, Image, ImageBackground, TouchableOpacity, TouchableHighlight, Alert} from "react-native";
    ...
    this.setState(state => {
      ...
      if (nextIndex >= state.totalCount) {
       // return this.props.navigation.popToTop();
        return this.props.navigation.navigate("C3_Guardar_V_preg_pcte2",{C3_ppcte2: 1});
      }
