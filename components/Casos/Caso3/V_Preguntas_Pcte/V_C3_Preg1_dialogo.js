...
import { Modal, View,ScrollView, StyleSheet, StatusBar, Text, SafeAreaView, Image, ImageBackground, TouchableOpacity, TouchableHighlight, Alert} from "react-native";
...
class V_C3_Preg1_dialogo extends React.Component {
    ...
    this.setState(state => {
      ...
      if (nextIndex >= state.totalCount) {
       // return this.props.navigation.popToTop();
        return this.props.navigation.navigate("V_C3_Preg1_pregunta", {activeQuestion: 1, 
          title: "Caso 3. Pregunta 1 ",
          questions: D_C3_pregunta1_pregunta,
          color: "#36b1f0"
        });
      }
...
export default V_C3_Preg1_dialogo;
