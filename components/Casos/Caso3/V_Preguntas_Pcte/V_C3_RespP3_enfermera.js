...
class V_C3_RespP3_enfermera extends React.Component {
    ...
    this.setState(state => {
      ...
      if (nextIndex >= state.totalCount) {
       // return this.props.navigation.popToTop();
        return this.props.navigation.navigate("C3_Guardar_V_preg_pcte3",{C3_ppcte3: 1});
      }
...
export default V_C3_RespP3_enfermera;
