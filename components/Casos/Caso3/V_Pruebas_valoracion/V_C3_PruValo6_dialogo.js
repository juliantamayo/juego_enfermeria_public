...
import { ModalHistorial, Modal_C3_Pru_valoracion6_procedimiento, Modal_C3_Pru_valoracion6_HN } from "../../../elementos/Modals";
import style from '../../../Style.js';
import D_C3_Pru_Valoracion6_pregunta from "../../../data/C3_data/C3_Pru_valoracion/D_C3_Pru_Valoracion6_pregunta";
...
class V_C3_PruValo6_dialogo extends React.Component {
    ...
    this.setState(state => {
      ...
      if (nextIndex >= state.totalCount) {
       // return this.props.navigation.popToTop();
        return this.props.navigation.navigate("V_C3_PruValo6_pregunta", {activeQuestion: 1, 
          title: "2 PrubValu6",
          questions: D_C3_Pru_Valoracion6_pregunta,
          color: "#36b1f0"
        });
      }
 ...
 setModalVisibleProcedimiento = (visible) => {
  ...
  render() {
    ...
    <ModalHistorial
      ...
      />
       <Modal_C3_Pru_valoracion6_procedimiento
...
export default V_C3_PruValo6_dialogo;
