...
import { C3_ModalHistorial, Modal_C3_Pru_valoracion1_procedimiento, Modal_C3_Pru_valoracion1_HN } from "../../../elementos/Modals";
import style from '../../../Style.js';
import D_C3_Pru_Valoracion1_pregunta from "../../../data/C3_data/C3_Pru_valoracion/D_C3_Pru_Valoracion1_pregunta";
...
class V_C3_PruValo1_dialogo extends React.Component {
    ...
    this.setState(state => {
      ...
      if (nextIndex >= state.totalCount) {
       // return this.props.navigation.popToTop();
        return this.props.navigation.navigate("V_C3_PruValo1_pregunta", {activeQuestion: 1, 
          title: "Caso 3. Prueba de valoración 1",
          questions: D_C3_Pru_Valoracion1_pregunta,
          color: "#36b1f0"
        });
      }
  ...
  render() {
    ...
    <C3_ModalHistorial
      ...
      <Modal_C3_Pru_valoracion1_procedimiento
