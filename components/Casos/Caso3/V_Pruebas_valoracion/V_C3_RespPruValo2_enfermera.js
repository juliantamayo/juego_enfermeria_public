...
class V_C3_RespPruValo2_enfermera extends React.Component {
    ...
    this.setState(state => {
      ...
      if (nextIndex >= state.totalCount) {
       // return this.props.navigation.popToTop();
        return this.props.navigation.navigate("C3_Guardar_V_pru_valo2",{C3_pv2:1});
      }
...
export default V_C3_RespPruValo2_enfermera;
