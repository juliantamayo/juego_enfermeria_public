...
import { View, StyleSheet,ScrollView, StatusBar, Text, SafeAreaView, Image, ImageBackground, TouchableOpacity} from "react-native";

import { Button, ButtonContainer } from "../../../elementos/ButtonEscene1";
import { C3_ModalHistorial, Modal_C3_Pru_valoracion5_procedimiento, Modal_C3_Pru_valoracion5_HN } from "../../../elementos/Modals";
import style from '../../../Style.js';
import D_C3_Pru_Valoracion5_pregunta from "../../../data/C3_data/C3_Pru_valoracion/D_C3_Pru_Valoracion5_pregunta";
import { CommonActions } from '@react-navigation/native';
import { Modal_Pruebas } from "../../../elementos/ModalsTutorial";
import  styles  from "../../../Style_dialog.js";


class V_C3_PruValo5_dialogo extends React.Component {
    ...
    this.setState(state => {
      ...
      if (nextIndex >= state.totalCount) {
       // return this.props.navigation.popToTop();
        return this.props.navigation.navigate("V_C3_PruValo5_pregunta", {activeQuestion: 1, 
          title: "Caso 3. Prueba de valoración 5",
          questions: D_C3_Pru_Valoracion5_pregunta,
          color: "#36b1f0"
        });
      }
  ...
  render() {
    ...
    <C3_ModalHistorial
      ...
      />
      <Modal_C3_Pru_valoracion5_procedimiento
...
export default V_C3_PruValo5_dialogo;
