...
import { View, StyleSheet,ScrollView, Dimensions, StatusBar, Text, SafeAreaView, Image, ImageBackground, TouchableOpacity, TouchableHighlight, Alert} from "react-native";
...
class V_C3_RespPruValo3_enfermera extends React.Component {
    ...
    this.setState(state => {
      ...
      if (nextIndex >= state.totalCount) {
       // return this.props.navigation.popToTop();
        return this.props.navigation.navigate("C3_Guardar_V_pru_valo3",{C3_pv3:1});
      }
...
export default V_C3_RespPruValo3_enfermera;
