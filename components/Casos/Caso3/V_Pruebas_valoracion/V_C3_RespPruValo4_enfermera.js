...
class V_C3_RespPruValo4_enfermera extends React.Component {
  ...
  nextQuestion = () => {
    this.setState(state => {
      ...
      if (nextIndex >= state.totalCount) {
        ...
        return this.props.navigation.navigate("C3_Guardar_V_pru_valo4",{C3_pv4:1});
      }
...
export default V_C3_RespPruValo4_enfermera;
