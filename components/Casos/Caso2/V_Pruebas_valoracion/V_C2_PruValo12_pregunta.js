...
import D_C2_Pru_Valoracion12_Resp_enfermera from "../../../data/C2_data/C2_Pru_valoracion/D_C2_Pru_Valoracion12_Resp_enfermera";
import { Alert } from "../../../elementos/Alert";
import  styles  from "../../../Style_preguntas.js";
 
const mult =5;

class V_C2_PruValo12_pregunta extends React.Component {
    ...
    this.setState(state => {
      ...
      if (nextIndex >= state.totalCount && this.state.correctCount < 2) {
       // return this.props.navigation.popToTop();
        return this.props.navigation.navigate('V_C2_PruValo12_dialogo',{experiencia: (this.state.correctCount*mult)-((this.state.totalCount-this.state.correctCount)*3), correctas:this.state.correctCount,erroneas:(this.state.totalCount-this.state.correctCount)});
...
export default V_C2_PruValo12_pregunta;
