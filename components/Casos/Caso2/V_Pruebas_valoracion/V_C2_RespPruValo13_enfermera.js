...
import { View,ScrollView, Text, Image, ImageBackground, TouchableOpacity, Alert} from "react-native";
...
class V_C2_RespPruValo13_enfermera extends React.Component {
  ...
  nextQuestion = () => {
    this.setState(state => {
      ...
      if (nextIndex >= state.totalCount) {
       ...
       return this.props.navigation.navigate("C2_Guardar_V_pru_valo13",{C2_pv13:1});
      }
...
export default V_C2_RespPruValo13_enfermera;
