...
class V_C2_RespPruValo4_enfermera extends React.Component {
    ...
    this.setState(state => {
      ...
      if (nextIndex >= state.totalCount) {
       // return this.props.navigation.popToTop();
        return this.props.navigation.navigate("C2_Guardar_V_pru_valo4",{C2_pv4:1});
      }
...
export default V_C2_RespPruValo4_enfermera;
