...
import { View,StatusBar, Text, SafeAreaView,ScrollView, Image, ImageBackground, TouchableOpacity} from "react-native";

import { Button, ButtonContainer } from "../../../elementos/ButtonEscene1";
import { C2_ModalHistorial, Modal_C2_Pru_valoracion11_procedimiento, Modal_C2_Pru_valoracion11_HN } from "../../../elementos/Modals";
import style from '../../../Style.js';
import D_C2_Pru_Valoracion11_pregunta from "../../../data/C2_data/C2_Pru_valoracion/D_C2_Pru_Valoracion11_pregunta";
import { CommonActions } from '@react-navigation/native';
import  styles  from "../../../Style_dialog.js";
import { Modal_Pruebas } from "../../../elementos/ModalsTutorial";

class V_C2_PruValo11_dialogo extends React.Component {
    ...
    this.setState(state => {
      ...
      if (nextIndex >= state.totalCount) {
       // return this.props.navigation.popToTop();
        return this.props.navigation.navigate("V_C2_PruValo11_pregunta", {activeQuestion: 1, 
          title: "Caso 2. Prueba de Valoración 11",
          questions: D_C2_Pru_Valoracion11_pregunta,
          color: "#36b1f0"
        });
      }
  ...
  render() {
    ...
    <C2_ModalHistorial
      ...
      />
      <Modal_C2_Pru_valoracion11_procedimiento
...
export default V_C2_PruValo11_dialogo;
