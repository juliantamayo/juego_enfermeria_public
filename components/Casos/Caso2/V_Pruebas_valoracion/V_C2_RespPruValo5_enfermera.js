...
class V_C2_RespPruValo5_enfermera extends React.Component {
    ...
    this.setState(state => {
      ...
      if (nextIndex >= state.totalCount) {
       // return this.props.navigation.popToTop();
        return this.props.navigation.navigate("C2_Guardar_V_pru_valo5",{C2_pv5:1});
      }
...
export default V_C2_RespPruValo5_enfermera;
