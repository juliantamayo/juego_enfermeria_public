...
import { Modal, View, ScrollView, Text, SafeAreaView, Image, ImageBackground, TouchableOpacity, TouchableHighlight, Alert} from "react-native";
...
class V_C2_Preg1_dialogo extends React.Component {
    ...
    this.setState(state => {
      ...
      if (nextIndex >= state.totalCount) {
       // return this.props.navigation.popToTop();
        return this.props.navigation.navigate("V_C2_Preg1_pregunta", {activeQuestion: 1, 
          title: "Caso 2. Pregunta 1",
          questions: D_C2_pregunta1_pregunta,
          color: "#36b1f0"
        });
      }
...
export default V_C2_Preg1_dialogo;
