...
import {AsyncStorage, Modal, View, StyleSheet, Dimensions, ScrollView, StatusBar, Text, SafeAreaView, Image, ImageBackground, TouchableOpacity, TouchableHighlight, Alert} from "react-native";
...
class V_C2_RespP5_enfermera extends React.Component {
    ...
    this.setState(state => {
      ...
      if (nextIndex >= state.totalCount) {
       // return this.props.navigation.popToTop();
        return this.props.navigation.navigate("C2_Guardar_V_preg_pcte5",{C2_ppcte5: 1});
      }
...
export default V_C2_RespP5_enfermera;
