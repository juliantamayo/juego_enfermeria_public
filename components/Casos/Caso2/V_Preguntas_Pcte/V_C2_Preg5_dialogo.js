...
import { Modal, View, StyleSheet,ScrollView, Dimensions, StatusBar, Text, SafeAreaView, Image, ImageBackground, TouchableOpacity, TouchableHighlight, Alert} from "react-native";

import { Button, ButtonContainer } from "../../../elementos/ButtonEscene1";
import { C2_ModalHistorial } from "../../../elementos/Modals";
import style from '../../../Style.js';
import D_C2_pregunta5_pregunta from "../../../data/C2_data/C2_preguntas/D_C2_pregunta5_pregunta";
import { CommonActions } from '@react-navigation/native';
import { Modal_Preguntas } from "../../../elementos/ModalsTutorial";
import  styles  from "../../../Style_dialog.js";


class V_C2_Preg5_dialogo extends React.Component {
    ...
    this.setState(state => {
      ...
      if (nextIndex >= state.totalCount) {
       // return this.props.navigation.popToTop();
        return this.props.navigation.navigate("V_C2_Preg5_pregunta", {activeQuestion: 1, 
          title: "Caso 2. Pregunta 5 ",
          questions: D_C2_pregunta5_pregunta,
          color: "#36b1f0"
        });
      }
...
export default V_C2_Preg5_dialogo;
