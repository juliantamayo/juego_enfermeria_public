...
import { View, ScrollView, StyleSheet, Dimensions, StatusBar, Text, SafeAreaView, Image, ImageBackground, TouchableOpacity, TouchableHighlight, Alert} from "react-native";
import { Button, ButtonContainer } from "../../../elementos/ButtonEscene1";
import style from '../../../Style.js';
import C1_pregunta5_pregunta from "../../../data/C1_preguntas/C1_pregunta5_pregunta";
...
class V_C1_Preg5_dialogo extends React.Component {
    ...
    this.setState(state => {
      ...
      if (nextIndex >= state.totalCount) {
       // return this.props.navigation.popToTop();
        return this.props.navigation.navigate("V_C1_Preg5_pregunta", {activeQuestion: 1, 
          title: "Caso 1. Pregunta 5",
          questions: C1_pregunta5_pregunta,
          color: "#36b1f0"
        });
      }
...
export default V_C1_Preg5_dialogo;
