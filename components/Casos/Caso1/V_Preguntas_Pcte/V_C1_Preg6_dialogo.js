...
import C1_pregunta6_pregunta from "../../../data/C1_preguntas/C1_pregunta6_pregunta";
...
class V_C1_Preg6_dialogo extends React.Component {
    ...
    this.setState(state => {
      ...
      if (nextIndex >= state.totalCount) {
       // return this.props.navigation.popToTop();
        return this.props.navigation.navigate("V_C1_Preg6_pregunta", {activeQuestion: 1, 
          title: "Caso 1. Pregunta 6",
          questions: C1_pregunta6_pregunta,
          color: "#36b1f0"
        });
      }
...
export default V_C1_Preg6_dialogo;
