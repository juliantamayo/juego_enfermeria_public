...
class V_C1_RespP6_enfermera extends React.Component {
    ...
    this.setState(state => {
      ...
      if (nextIndex >= state.totalCount) {
       // return this.props.navigation.popToTop();
        return this.props.navigation.navigate("Guardar_V_preg_pcte6", {ppcte6: 0.2, 
...
export default V_C1_RespP6_enfermera;
