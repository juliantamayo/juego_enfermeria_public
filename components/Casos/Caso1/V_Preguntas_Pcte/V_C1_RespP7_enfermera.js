...
class V_C1_RespP7_enfermera extends React.Component {
    ...
    this.setState(state => {
      ...
      if (nextIndex >= state.totalCount) {
       // return this.props.navigation.popToTop();
        return this.props.navigation.navigate("Guardar_V_preg_pcte7", {ppcte7: 0.2,
...
export default V_C1_RespP7_enfermera;
