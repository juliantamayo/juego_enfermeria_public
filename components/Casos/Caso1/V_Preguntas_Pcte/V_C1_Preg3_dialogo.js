...
import C1_pregunta3_pregunta from "../../../data/C1_preguntas/C1_pregunta3_pregunta";
...
class V_C1_Preg3_dialogo extends React.Component {
    ...
    this.setState(state => {
      ...
      if (nextIndex >= state.totalCount) {
       // return this.props.navigation.popToTop();
        return this.props.navigation.navigate("V_C1_Preg3_pregunta", {activeQuestion: 1, 
          title: "3.Preguntas",
          questions: C1_pregunta3_pregunta,
          color: "#36b1f0"
        });
      }
...
export default V_C1_Preg3_dialogo;
