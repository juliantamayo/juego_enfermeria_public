...
import { ModalHistorial, Modal_C1_Pru_valoracion1_procedimiento, Modal_C1_Pru_valoracion1_HN } from "../../../elementos/Modals";
import style from '../../../Style.js';
import D_C1_Pru_Valoracion1_pregunta from "../../../data/C1_data/C1_Pru_valoracion/D_C1_Pru_Valoracion1_pregunta";
...
class V_C1_PruValo1_dialogo extends React.Component {
    ...
    this.setState(state => {
      ...
      if (nextIndex >= state.totalCount) {
       // return this.props.navigation.popToTop();
        return this.props.navigation.navigate("V_C1_PruValo1_pregunta", {activeQuestion: 1, 
          title: "Caso 1. Prueba de Valoración 1",
          questions: D_C1_Pru_Valoracion1_pregunta,
          color: "#36b1f0"
        });
      }
  ...
  render() {
    ...
    <ModalHistorial
      ...
      <Modal_C1_Pru_valoracion1_procedimiento
...
export default V_C1_PruValo1_dialogo;
