...
import { View,ScrollView, Text, SafeAreaView, Image, ImageBackground, TouchableOpacity} from "react-native";

import { Button, ButtonContainer } from "../../../elementos/ButtonEscene1";
import { ModalHistorial, Modal_C1_Pru_valoracion6_procedimiento, Modal_C1_Pru_valoracion6_HN } from "../../../elementos/Modals";
 ...
 setModalVisibleProcedimiento = (visible) => {
  ...
  render() {
    ...
    <ModalHistorial
      ...
      />
       <Modal_C1_Pru_valoracion6_procedimiento
