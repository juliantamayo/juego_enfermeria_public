...
import { View, StyleSheet, StatusBar, Text, SafeAreaView, Image, ImageBackground, TouchableOpacity} from "react-native";

import { Button, ButtonContainer } from "../../../elementos/ButtonEscene1";
import { ModalHistorial, Modal_C1_Pru_valoracion5_procedimiento, Modal_C1_Pru_valoracion5_HN } from "../../../elementos/Modals";
import style from '../../../Style.js';
import D_C1_Pru_Valoracion5_pregunta from "../../../data/C1_data/C1_Pru_valoracion/D_C1_Pru_Valoracion5_pregunta";
...
class V_C1_PruValo5_dialogo extends React.Component {
  ...
  render() {
    ...
    <ModalHistorial
      ...
      />
      <Modal_C1_Pru_valoracion5_procedimiento
...
export default V_C1_PruValo5_dialogo;
