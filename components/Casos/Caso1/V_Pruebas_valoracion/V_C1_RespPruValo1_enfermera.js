...
import { Modal, View,ScrollView, Dimensions, StatusBar, Text, SafeAreaView, Image, ImageBackground, TouchableOpacity, TouchableHighlight, Alert} from "react-native";
...
class V_C1_RespPruValo1_enfermera extends React.Component {
    ...
    this.setState(state => {
      ...
      if (nextIndex >= state.totalCount) {
       // return this.props.navigation.popToTop();
        return this.props.navigation.navigate("Guardar_V_pru_valo1",{pv1:0.1});
      }
...
export default V_C1_RespPruValo1_enfermera;
