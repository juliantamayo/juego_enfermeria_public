  ...
  <Modal
        ...
        >
          ...
          <ScrollView>
                ...
                <Text style={styles.modalText}> Dolor al orinar desde hace dos días.{"\n"}{"\n"}{"\n"}{"\n"}</Text>
                </Text>
           </ScrollView>
          </View>
          ...
          <View style={styles.slide}>
           ...
           <Text style={styles.margen}></Text>
                ...
                <Text style={styles.modalText}> Vive con su esposa Liliana de 57 años y sus tres hijas, siendo la mayor Lorena, la menor Lucia e intermedia Laura, viven en un tercer piso con ascensor, tienen buena relación familiar. 
                    {"\n"}{"\n"}Se le debe asistir en la alimentación porque su esposa dice que “él siempre se le olvida comerse los alimentos del lado derecho del plato” y cuando empezó con el problema de la orina, él estaba en proceso de recuperación y en terapia.{"\n"}{"\n"}{"\n"}{"\n"}</Text>
                </Text>
           </ScrollView>
          </View>
        </Swiper>
  ...
  <Modal
        ...
        >
          <View style={styles.slide}>
            <ScrollView>
                ...
                <Text style={styles.modalTextcuerpo}>
                <Text style={styles.modalTextnegrilla}>Antecedentes farmacológicos: </Text>
                <Text style={styles.modalText}> Ninguno. {"\n"}{"\n"}{"\n"}{"\n"}</Text>
                </Text>
       ...
       <StatusBar barStyle="dark-content" />
          ...
          <View style={styles.slide}>
                ...
                <Text style={styles.modalText}>Café o jugo con pan. {"\n"}{"\n"}{"\n"}{"\n"}</Text>
                </Text>
        ...
        >
          ...
          <ScrollView>
               ...
               <Text style={styles.modalText}> No debe usarse amoniaco, vinagre, formol u otras sustancias, que irritarían las terminaciones sensitivas del V par.</Text>
                ...
                <Text style={styles.modalTextcuerpo}>
                <Text style={styles.modalTextnegrilla}>2. </Text>
                <Text style={styles.modalText}> Se le pide a la persona a valorar que: Con la mano derecha ocluya la fosa nasal derecha con su dedo índice preferiblemente, mantenga la boca cerrada y cierre los ojos, así del mismo modo con la otra fosa nasal. {"\n"}{"\n"}{"\n"}{"\n"} </Text>
                </Text>
          </ScrollView>
            ...
            <ScrollView>
              <Text style={styles.modalTextcuerpo}>
                ...
                <Text style={styles.modalText}> Cada lado de las fosas nasales debe ser explorado separadamente, la enfermera del servicio le pregunta al paciente que olor fue el que percibió y si la percepción fue leve o no. Repita el procedimiento en la otra fosa nasal. </Text>
                   ...
                   <Text style={styles.modalTextcuerpo}>
                <Text style={styles.modalTextnegrilla}>5. </Text>
                <Text style={styles.modalText}> Debemos preguntar primero si siente o no el olor y si responde positivamente, se le insta a que identifique el olor. {"\n"}{"\n"}{"\n"}{"\n"}  </Text>
                </Text>
                   </ScrollView>
             </View>
          ...
          <View style={styles.slide}>
           <ScrollView>
             <Text style={styles.modalTextcuerpo}>
                ...
                <Text style={styles.modalText}>Es importante aclarar que aunque no se identifique exactamente, la apreciación por el sujeto de un olor, es suficiente para excluir la anosmia (pérdida del olfato).{"\n"}{"\n"}{"\n"}{"\n"}  </Text>
                </Text> 
               </ScrollView>
             </View>
  ...
  <Modal
        ...
        >
          ...
          <ScrollView>
               ...
               <Text style={styles.modalTextcuerpo}>
                <Text style={styles.modalTextnegrilla}>2. </Text>
                <Text style={styles.modalText}>Se utiliza para ello un pincel o escobillón se irán tocando sucesivamente en región oftálmica, maxilar y mandibular.  {"\n"}{"\n"}{"\n"}{"\n"}   </Text>
                </Text>
                </ScrollView>
          </View>
        ...
        >
          ...
          <View style={styles.slide}>
            <ScrollView>
                ...
                <Text style={styles.modalTextcuerpo}>
                <Text style={styles.modalText}>El paciente es capaz de discriminar entre sensación de calor y frio en áreas simétricas (ambos lados de la cara o el cuerpo tales como codos derecho e izquierdo, antebrazo derecho e izquierdo). El paciente siente el toque suave y la calidad de la sensación debe ser similar en áreas simétricas (en ambos lados de la cara).{"\n"}{"\n"}{"\n"}{"\n"} </Text>
                </Text>
                </ScrollView>
                   </View>
                 <View style={styles.slide}>
  ...
  <Modal
        ...
        >
          ...
          <View style={styles.slide}>
                ...
                <Text style={styles.modalTextcuerpo}>
                <Text style={styles.modalTextnegrilla}>2. </Text>
                <Text style={styles.modalText}>Pida al sujeto que abra su boca, mientras con una mano se opone a ello. El masetero se contrae, cuando el paciente abre la boca lentamente se verá que esta su alineación mandibular (No se debe evidenciar desviación mandibular). {"\n"}{"\n"}{"\n"}{"\n"} </Text>
         ...
         <ScrollView>
                ...
                <Text style={styles.margen}>   </Text>
                 <Text style={styles.modalTextcuerpo}>
                <Text style={styles.modalTextnegrilla}> - </Text>
                <Text style={styles.modalText}>Se obtiene colocando el dedo índice sobre la parte del mentón con la boca entre abierta y percutiendo con un martillo sobre este.{"\n"}{"\n"}{"\n"}{"\n"}  </Text>
                </Text>
            </ScrollView>
          </View>
          ...
          <View style={styles.slide}>
             ...
             <Text style={styles.margen}>   </Text>
                ...
                <Text style={styles.modalTextnegrilla}>Percusión del Reflejo Maseterino:   </Text>
                  <Text style={styles.modalText}>la respuesta será una rápida contracción bilateral de los músculos maseteros y temporales.{"\n"}{"\n"}{"\n"}{"\n"}  </Text>
                </Text>
  ...
  <Modal
        ...
        >
         ...
         <ScrollView>
                ...
                <Text style={styles.modalText}>La fuerza muscular segmentaria de la lengua se explora ordenándole al sujeto que presione con la lengua una de las mejillas contra las cuales el examinador ha colocado sus dedos o mano por fuera.{"\n"}{"\n"}{"\n"}{"\n"} </Text>
                </Text>
          ...
          <ScrollView>
                ...
                <Text style={styles.modalText}>Si se siente más intenso o solo se oye en uno de los oídos, se dice que el Weber está lateralizado hacia el lado donde aumenta su intensidad. Cuando el “aparato de trasmisión” está afectado, la percepción ósea aumenta y la misma es más intensa en el lado enfermo y cuando está afectado el nervio, la percepción es más intensa, o solo ocurre, en el lado sano.  {"\n"}{"\n"}{"\n"} </Text>
                 ...
                 <ScrollView>
                   <Text style={styles.modalTextcuerpo}>
                <Text style={styles.modalTextnegrilla}>4. </Text>
                <Text style={styles.modalText}>Si el Weber está lateralizado, repita la prueba ocluyendo primero, el oído que se está explorando y después el otro. {"\n"}{"\n"}Normalmente el diapasón se oye mejor cuando el oído tiene ocluido su conducto auditivo externo.{"\n"}{"\n"} Si con el oído que ha sido ocluido por la enfermera no se oye nada, entonces estamos en presencia de una sordera troncular o nerviosa de ese lado y si las vibraciones del diapasón ahora se sienten con intensidad similar en ambos oídos, se trata de una sordera ósea o de trasmisión, del lado no ocluido.{"\n"}{"\n"}{"\n"} </Text>
                </Text>
                </ScrollView>
                  </View>
  ...
  <Modal
       ...
       <StatusBar barStyle="dark-content" />
            ...
            <View style={styles.slide}>
                  ...
                  <Text style={styles.modalTextcuerpo}>
                <Text style={styles.modalTextnegrilla}>1. </Text>
                <Text style={styles.modalText}>El paciente puede estar acostado o sentado.   {"\n"}</Text>
                </Text>
                <Text style={styles.modalTextcuerpo}>
                <Text style={styles.modalTextnegrilla}>2. </Text>
  ...
  <Modal
       ...
       <StatusBar barStyle="dark-content" />       
          <View style={styles.slide}>
                ...
                <Text style={styles.modalTextcuerpo}>
                <Text style={styles.modalText}>- Este reflejo pone en evidencia la raíz C5 y C6 del raquis cervical y produce la flexión del antebrazo sobre el brazo.{"\n"}{"\n"}{"\n"}</Text>
                </Text>
  ...
  <Modal
       ...
       <StatusBar barStyle="dark-content" />
          <View style={styles.slide}>
                  ...
                  <Text style={styles.modalTextcuerpo}>
                <Text style={styles.modalTextnegrilla}>1. </Text>
                <Text style={styles.modalText}>El paciente debe estar en sedestación(sentado), apoyar el codo sobre abdomen levemente en pronación.  {"\n"}</Text>
                </Text>
                <Text style={styles.modalTextcuerpo}>
                <Text style={styles.modalTextnegrilla}>2. </Text>
  ...
  <Modal
       ...
       <StatusBar barStyle="dark-content" />       
          <View style={styles.slide}>
                ...
                <Text style={styles.modalTextcuerpo}>
                <Text style={styles.modalText}>- Se evidencia la flexión y la supinación de la muñeca. </Text>
                </Text>
  ...
  <Modal
        ...
        >
          ...
          <ScrollView>
                ...
                <Text style={styles.modalTextcuerpo}>
                <Text style={styles.modalTextnegrilla}>Motivo de Consulta: </Text>
                <Text style={styles.modalText}> Dolor en el abdomen en su parte superior y nauseas desde hace 2 días.{"\n"}{"\n"}{"\n"}{"\n"} </Text>
                </Text>
            </ScrollView>
  ...
  <Modal
       ...
       <StatusBar barStyle="dark-content" />       
          <View style={styles.slide}>
                ...
                <Text style={styles.modalTextcuerpo}>
                <Text style={styles.modalText}> {"\n"}Abdomen blando, depresible, no doloroso a la palpación  profunda, no masas palpables.{"\n"}{"\n"}{"\n"}{"\n"}</Text>
                </Text>
