   ...
   <ImageBackground source={require("../../../assets/images/background.png")}style={styles.container} resizeMode='contain'>
    ...
    <Modal_C1_escena2 text={modalVisible} onPress={() => { this.setModalVisible(!modalVisible); }} />
     ...
     <Swiper
      ...
      <Text style={style.text}>El diencéfalo se sitúa por encima del tronco encefálico y etsá rodeado por los hemisferios cerebrales.{"\n"}{"\n"}Las principales estructura del diencéfalo son:   </Text>
      <Text style={style.subtext}>El tálamo</Text>
       <Text style={style.subtext}>El hipotálamo</Text>
        <Text style={style.subtext}>Epitálamo</Text>
